...
from volsurf.cli.commands import ingest, fit, analyze, terminal, utils, intraday, batch, journal, macro
...
app.add_typer(macro.app, name="macro", help="Macro context data commands")
